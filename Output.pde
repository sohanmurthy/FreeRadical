...
int[] buildPoints() {
  int pointIndices[] = new int[360];
  int i = 0;
  for (int strips = 0; strips < 12; strips = strips + 1) {
    for (int pixels_per_strip = 0; pixels_per_strip < 30; pixels_per_strip = pixels_per_strip + 1) {
